...
from efficientnet_b7 import MyEfficientNetB7, extract_feats_efficientnet_bat
from efficientnet_b0 import MyEfficientNetB0, extract_feats_efficientnet
from mobilenet import MyMobilenet,extract_feats_mobilenet
from resnet_MY import MyResnet, extract_feats_resnet50


_MODELS = ['resnet-50', 'mobilenet', 'effb7', 'effb0']
...
def set_model (model_name, num_class, neurons_reducer_block=0, comb_method=None, comb_config=None, pretrained=True,
    ...
    if model_name == 'resnet-50':
        ...
        model = MyEfficientNetB7(models.efficientnet_b7(pretrained=pre_torch), num_class, neurons_reducer_block,
                                 freeze_conv,
                                 comb_method=comb_method, comb_config=comb_config)

    elif model_name == 'effb0':
        model = MyEfficientNetB0(models.efficientnet_b0(pretrained=pre_torch), num_class, neurons_reducer_block,
                                 freeze_conv,
                                 comb_method=comb_method, comb_config=comb_config)
    return model
...
def get_activation_fn(model_name):
    ...
    if model_name == 'resnet-50':
        ...
        activation_fn = extract_feats_efficientnet_bat
    elif model_name == 'effb0':
        activation_fn = extract_feats_efficientnet
    else:
        raise
