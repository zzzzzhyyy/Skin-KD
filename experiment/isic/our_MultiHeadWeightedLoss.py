...
from kd_losses import MultiHeadWeightedLoss
...
def main (_folder, _csv_path_train, _imgs_folder_train, _csv_path_test, _imgs_folder_test, _lr_init, _sched_factor,
    ...
    model_t_ckpt_path = "results/" + "LR" + str(_comb_method) + "_" + _model_name_teacher + \
    ...
    loss_fn = MultiHeadWeightedLoss(weight = 0.2, entropy_weight = 0.05).to(device)
